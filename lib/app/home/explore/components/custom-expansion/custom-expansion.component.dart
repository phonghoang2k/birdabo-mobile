                    ...
                    child: Card(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                            ...
                            gradient:
                                LinearGradient(begin: Alignment.topCenter, end: Alignment.bottomCenter, colors: [Colors.white, Color(0xFFEFEFEF)])),
                        child: Icon(Icons.expand_more, color: Color(0xFF2196F3)),
                      ),
                    ),
                  ),
            ),
